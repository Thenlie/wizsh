...
Command cmd_arr[] = {
    ...
    // -- CHANGE DIR --
    {
        ...
        {
                "cd <file_path> \033[0m| The main usage of the command. Navigate to \033[1;33mfile_path\033[0m.\n",
    ...
    // -- CLEAR TERM --
    {
        ...
        {
            "clear        \033[0m| The main usage of the command\n",
    ...
    // -- PRINT CURRENT DIR --
    {
        ...
        {
            "dir        \033[0m| The main usage of the command\n",
    ...
    // -- LIST FILES IN CURRENT DIR --
    {
        ...
        {
            "ls        \033[0m| The main usage of the command\n",
    ...
    // -- MAKE DIR --
    {
        ...
        {
            "mkdir <directory_name> \033[0m| The main usage of the command. Create a directory called \033[1;33<directory_name>\033[0m.\n",
    ...
    // -- MAKE FILE --
    {
        ...
        {
            "mk <file_name> \033[0m| The main usage of the command. Create a directory called \033[1;33<file_name>\033[0m.\n",
    ...
    // -- MOVE FILE --
    {
        ...
        {
            "move <old_path> <new_path> \033[0m| The main usage of the command. move a file called \033[1;33<old_path>\033[0m to \033[1;33<new_path>\033[0m.\n",
    ...
    // -- REMOVE FILE --
    {
        ...
        {
            "rmf <file_name> \033[0m| The main usage of the command. Remove a file called \033[1;33<file_name>\033[0m.\n",
    ...
    // -- REMOVE DIR --
    {
        ...
        {
            "rmdir <directory_name> \033[0m| The main usage of the command. Remove a directory called \033[1;33<directory_name>\033[0m.\n",
    ...
    // -- WRITE TO FILE --
    {
        ...
        {
            "write <file_name> <input>             \033[0m| The main usage of the command. Write \033[1;33m<input>\033[0m to \033[1;33m<file_name>\033[0m\n",
    ...
    // -- READ FILE --
    {
        ...
        {
            "read <file_name> \033[0m| The main usage of the command. Read a file called \033[1;33m<file_name>\033[0m.\n",
    ...
    // -- OPEN WITH VIM --
    {
        ...
        {
            "vim <file_path> \033[0m| The main usage of the command. Open \033[1;33m<file_name>\033[0m with Vim.\n",
